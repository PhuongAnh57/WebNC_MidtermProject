        ...
        <div style={{width: '920px', margin: 'auto'}}>
            <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                <div style={{display: 'flex', alignItems: 'center'}}>
                    ...
                    <span style={{fontSize: '32px', fontWeight: '400', color: '#4285f4', alignSelf: 'center'}}>Bài tập 1</span>
                </div>
            ...
            <Box sx={{ml: '58px', fontSize: '14px'}}>
                ...
                <div style={{margin: '8px 0px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: '#3c4043', fontWeight: '600'}}>
                    <span>100 điểm</span>
                ...
                <div style={{display: 'flex', alignItems: 'center', color: '#5F6368', fontWeight: '600', marginTop: '16px'}}>
                    <PeopleAltOutlinedIcon />
                    <span style={{alignSelf: 'center', marginLeft: '8px'}}>Nhận xét của lớp học</span>
                </div>

                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 8px 16px 0px'}}>
                    <Fab size="small" sx={{background: '#4285f4', color: '#ffffff', mr: 2}}>
                        <AssignmentOutlinedIcon />
                    </Fab>
